 ...
 * {@link AbstractAnalyzer} requires a {@link ExecutionDataStore} instance that
...
public abstract class AbstractAnalyzer {
	...
	protected final ExecutionDataStore executionData;
	 ...
	 *            execution data
	 */
	public AbstractAnalyzer(final ExecutionDataStore executionData) {
	 ...
	 */
	protected abstract ClassVisitor createAnalyzingVisitor(long classid,
			String className);
